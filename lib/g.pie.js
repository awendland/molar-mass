...
(function () {
    ...
    function Piechart(paper, cx, cy, r, values, opts) {
        ...
        if (len == 1) {
            ...
            values[0] = { value: values[0].value, identifier: values[0].id, order: 0, valueOf: function () { return this.value; } };
            ...
            for (var i = 0; i < len; i++) {
                ...
                values[i] = { value: values[i].value, identifier: values[i].id, order: i, valueOf: function () { return this.value; } };
            }
